...
emr = materials['MoGR']['emr']
rho = materials['MoGR']['rho']
hcut = materials['MoGR']['hcut']
bnref = materials['MoGR']['bnref']

csref0 = materials['MoGR']['csref'][0]
csref1 = materials['MoGR']['csref'][1]
csref4 = materials['MoGR']['csref'][4]
csref5 = materials['MoGR']['csref'][5]

radl = materials['MoGR']['radl']
dlri = materials['MoGR']['dlri']
dlyi = materials['MoGR']['dlyi']
eUm = materials['MoGR']['eUm']
