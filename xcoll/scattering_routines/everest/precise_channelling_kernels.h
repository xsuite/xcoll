...
#ifndef XCOLL_PRECISE_CHANNELLING_KERNELS_H
#define XCOLL_PRECISE_CHANNELLING_KERNELS_H
...
// beta_i / a_TF
///*gpufun*/
// double beta_over_aTF_(void) {
//    return beta_i/aTF;
//}

///*gpufun*/
// double aTF_over_beta_(void) {
//    return aTF/beta_i;
//}

///*gpufun*/
// double two_aTF_over_beta_(void) {
//    return 2.0*aTF/beta_i;
//}

// U_N = 2 Umax alpha_i / beta_i * exp( -beta_i dp / (2 aTF) )
/*gpufun*/
double U_N_(double Umax, double dp, double alpha_i, double beta_i, double beta_over_aTF) {
...
/*gpufun*/
double U_simplemoliere(double x, double U_N, double beta_over_aTF) {
...
/*gpufun*/
double E_T_simplemoliere(double theta, double bpc, double U) {
...
// m(E_T) = (E_T + 2U_N) / E_T
///*gpufun*/
// double m_simplemoliere(double E_T, double U_N) {
//    return 1.0 + 2.0 * U_N / E_T;
//}

// m' = 1/m
///*gpufun*/
// double mp_simplemoliere(double E_T, double U_N) {
...
/*gpufun*/
double nu_simplemoliere(double theta, double E_T, double bpc, double beta_over_aTF) {
...
// Phase φ(x)
/*gpufun*/
double phi_simplemoliere(double x, double U_N, double U, double m, double mp, double sqrt_mp) {
...
/*gpufun*/
void motion_parameters_simplemoliere(
...
#endif // XCOLL_PRECISE_CHANNELLING_KERNELS_H
