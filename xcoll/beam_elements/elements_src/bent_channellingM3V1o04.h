...
#ifndef XCOLL_BENT_CHANNELLINGDEV_M3V1O04_H
#define XCOLL_BENT_CHANNELLINGDEV_M3V1O04_H
...
/*gpufun*/
void BentChannellingDevM3V1o04_track_local_particle(BentChannellingDevM3V1o04Data el, LocalParticle* part0) {

    double length = BentChannellingDevM3V1o04Data_get_length(el);
    ...
    //start_per_particle_block (part0->part)
        ...
        fM3O4v1(x0, theta0, s, dp, uT, U0mol, alpha_i, beta_i, aTF, bpc, R, &x, &theta);
...
#endif /* XCOLL_BENT_CHANNELLINGDEV_M3V1O04_H */
