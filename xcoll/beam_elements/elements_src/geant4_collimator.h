...
/*gpufun*/
CollimatorGeometry Geant4Collimator_init_geometry(Geant4CollimatorData el, LocalParticle* part0){
...
/*gpufun*/
void Geant4Collimator_free(CollimatorGeometry restrict cg){
    if (cg->side != -1){
...
void Geant4Collimator_track_local_particle(Geant4CollimatorData el, LocalParticle* part0){
    ...
    if (active){
        cg = Geant4Collimator_init_geometry(el, part0);
        record_scatterings = Geant4CollimatorData_get_record_scatterings(el);
    }
