...
#ifndef XCOLL_BENT_CHANNELLINGDEV_M4V1O12_H
#define XCOLL_BENT_CHANNELLINGDEV_M4V1O12_H
...
/*gpufun*/
void BentChannellingDevM4V1o12_track_local_particle(BentChannellingDevM4V1o12Data el, LocalParticle* part0) {

    double length = BentChannellingDevM4V1o12Data_get_length(el);
...
#endif /* XCOLL_BENT_CHANNELLINGDEV_M4V1O12_H */
