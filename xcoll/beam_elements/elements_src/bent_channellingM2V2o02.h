...
#ifndef XCOLL_BENT_CHANNELLINGDEV_M2V2O02_H
#define XCOLL_BENT_CHANNELLINGDEV_M2V2O02_H
...
/*gpufun*/
void BentChannellingDevM2V2o02_track_local_particle(BentChannellingDevM2V2o02Data el, LocalParticle* part0) {

    double length = BentChannellingDevM2V2o02Data_get_length(el);
    ...
    //start_per_particle_block (part0->part)
        ...
        fM2O2v2(x0, theta0, s, dp, uT, U0mol, alpha_i, beta_i, aTF, bpc, R, &x, &theta);
...
#endif /* XCOLL_BENT_CHANNELLINGDEV_M2V2O02_H */
