...
/*gpufun*/
CollimatorGeometry Geant4CollimatorTip_init_geometry(Geant4CollimatorTipData el, LocalParticle* part0){
...
/*gpufun*/
void Geant4CollimatorTip_free(CollimatorGeometry restrict cg){
    if (cg->side != -1){
