...
#ifndef XCOLL_BENT_CHANNELLINGDEV_M3V1O08_H
#define XCOLL_BENT_CHANNELLINGDEV_M3V1O08_H
...
/*gpufun*/
void BentChannellingDevM3V1o08_track_local_particle(BentChannellingDevM3V1o08Data el, LocalParticle* part0) {

    double length = BentChannellingDevM3V1o08Data_get_length(el);
    ...
    //start_per_particle_block (part0->part)
        ...
        fM3O8v1(x0, theta0, s, dp, uT, U0mol, alpha_i, beta_i, aTF, bpc, R, &x, &theta);
...
#endif /* XCOLL_BENT_CHANNELLINGDEV_M3V1O08_H */
