...
def k2_track(exenergy, anuc, zatom, emr, rho, hcut, bnref, csref0, csref1, csref4, csref5, radl, dlri,
            dlyi, eUm, ai, collnt, cprob, xintl, bn, ecmsq, xln15s, bpp, is_crystal, c_length, c_rotation,
            c_aperture, c_offset, c_tilt, x_in, xp_in, y_in, yp_in, p_in, s_in, enom, lhit, part_abs_local, 
            impact, indiv, lint, onesided, nhit_stage, j_slices, nabs_type, linside, material, particles):
