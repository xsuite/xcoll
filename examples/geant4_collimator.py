...
coll1 = xc.Geant4Collimator(length=0.6, material=xc.materials.MolybdenumGraphite, jaw=0.001)
...
xc.geant4.engine.start(elements=coll1, clean=True, verbose=False)
...
print(f"Survived in Geant4: {len(part1.state[part1.state>0])}/{num_part}")
